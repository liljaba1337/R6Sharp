...
namespace R6Sharp
{
    internal static class Endpoints
    {
        ...
        internal const string Progression = "https://public-ubiservices.ubi.com/v1/spaces/{0}/sandboxes/OSBOR_PC_LNCH_A/r6playerprofile/playerprofile/progressions";
        internal const string Ranked = "https://public-ubiservices.ubi.com/v1/spaces/{0}/sandboxes/OSBOR_PC_LNCH_A/r6karma/players";
        internal const string Overall = "https://public-ubiservices.ubi.com/v1/spaces/{0}/sandboxes/OSBOR_PC_LNCH_A/playerstats2/statistics";
    }
}
