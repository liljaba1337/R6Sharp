...
namespace R6Sharp.Response
{
    ...
    public class BoardInfo
    {
        ...
        public BoardRankInfo BoardRankDetails { get => new BoardRankInfo(Rank); }

        [JsonPropertyName("max_rank")]
        public int MaxRank { get; set; }

        public BoardRankInfo BoardMaxRankDetails { get => new BoardRankInfo(MaxRank); }
